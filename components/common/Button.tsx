...
export default function Button({
  ...
  return (
    <button
      className={`transition-colors disabled:shadow-none disabled:bg-transparent disabled:text-gray-300 dark:disabled:text-gray-600 inline-flex items-center min-w-[38px] min-h-[38px] rounded px-3 py-1.5
            ${
              variant === "default"
